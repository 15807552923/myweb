...
(function(e) {
	e.fn.dragsort = function(t) {
		...
		this
				.each(function(t, o) {
					if (e(o).is("table") && e(o).children().size() == 1
					...
					var u = {
						...
						container : o,
						init : function() {
							n.tagName = e(this.container).children().size() == 0 ? "li"
									: e(this.container).children().get(0).tagName
											.toLowerCase();
							if (n.itemSelector == "")
							...
							if (n.placeHolderTemplate == "")
								n.placeHolderTemplate = "<" + n.tagName
										+ ">&nbsp;</" + n.tagName + ">";
							e(this.container).attr("data-listidx", t)
									.mousedown(this.grabItem).bind(
											"dragsort-uninit", this.uninit);
							this.styleDragHandlers(true)
						},
						uninit : function() {
							var t = r[e(this).attr("data-listidx")];
							e(t.container).unbind("mousedown", t.grabItem)
						...
						grabItem : function(t) {
							...
							var s = e(t.target).closest(
									"[data-listidx] > " + n.tagName).get(0);
						...
						dragStart : function(t) {
							...
							i.draggedItem = e(t.target).closest(
									"[data-listidx] > " + n.tagName);
							i.draggedItem.attr("data-origpos", e(this).attr(
									"data-listidx")
									+ "-"
							...
							i.offset.top = t.pageY - i.offset.top
									+ (isNaN(s) ? 0 : s) - 1;
							i.offset.left = t.pageX - i.offset.left
									+ (isNaN(o) ? 0 : o) - 1;
							if (!n.dragBetween) {
								var u = e(i.container).outerHeight() == 0 ? Math
										.max(1, Math.round(.5
												+ i.getItems().size()
								...
								i.offsetLimit.right = i.offsetLimit.left
										+ e(i.container).outerWidth()
										- i.draggedItem.outerWidth();
								i.offsetLimit.bottom = i.offsetLimit.top + u
										- i.draggedItem.outerHeight()
							}
							...
							if (n.tagName == "tr") {
								...
								i.placeHolderItem = i.draggedItem.clone().attr(
							...
							i.scroll.scrollY = window.setInterval(function() {
								...
								if (i.scroll.moveY > 0 && t < i.scroll.maxY
										|| i.scroll.moveY < 0 && t > 0) {
									e(n.scrollContainer).scrollTop(
											t + i.scroll.moveY);
									i.draggedItem.css("top", i.draggedItem
											.offset().top
											+ i.scroll.moveY + 1)
								}
							}, 10);
							i.scroll.scrollX = window.setInterval(function() {
								...
								if (i.scroll.moveX > 0 && t < i.scroll.maxX
										|| i.scroll.moveX < 0 && t > 0) {
									e(n.scrollContainer).scrollLeft(
											t + i.scroll.moveX);
									i.draggedItem.css("left", i.draggedItem
											.offset().left
											+ i.scroll.moveX + 1)
								}
							}, 10);
						...
						setPos : function(t, r) {
							...
							if (!n.dragBetween) {
								s = Math.min(this.offsetLimit.bottom, Math.max(
										s, this.offsetLimit.top));
								o = Math.min(this.offsetLimit.right, Math.max(
										o, this.offsetLimit.left))
							}
							var u = this.draggedItem.offsetParent().not("body")
									.offset();
							if (u != null) {
								s -= u.top;
								o -= u.left
							...
							if (n.scrollContainer == window) {
								...
								r = Math.max(0, r - e(window).height() + 5)
										+ Math.min(0, r - 5);
								t = Math.max(0, t - e(window).width() + 5)
										+ Math.min(0, t - 5)
							} else {
								var a = e(n.scrollContainer);
								var f = a.offset();
								r = Math.max(0, r - a.height() - f.top)
										+ Math.min(0, r - f.top);
								t = Math.max(0, t - a.width() - f.left)
										+ Math.min(0, t - f.left)
							}
							i.scroll.moveX = t == 0 ? 0 : t * n.scrollSpeed
									/ Math.abs(t);
							i.scroll.moveY = r == 0 ? 0 : r * n.scrollSpeed
									/ Math.abs(r);
						...
						dropItem : function() {
							...
							if (i.draggedItem.attr("data-origpos") != e(r)
									.index(i)
									+ "-"
									+ e(i.container).children().index(
											i.draggedItem))
								if (n.dragEnd.apply(i.draggedItem) == false) {
									var s = i.draggedItem.attr("data-origpos")
											.split("-");
									var o = e(r[s[0]].container).children()
											.not(i.draggedItem).eq(s[1]);
									if (o.size() > 0)
										o.before(i.draggedItem);
									else if (s[1] == 0)
										e(r[s[0]].container).prepend(
												i.draggedItem);
									else
										e(r[s[0]].container).append(
												i.draggedItem)
								}
						...
						swapItems : function(t) {
							...
							if (o == -1)
								return false;
							var f = function() {
								return e(u.container).children().not(
										u.draggedItem)
							};
							var l = f().not(n.itemSelector).each(function(e) {
								this.idx = f().index(this)
							});
							if (s == null || s.top > i.draggedItem.offset().top
						...
						createDropTargets : function() {
							...
							e(r)
									.each(
											function() {
												var t = e(this.container).find(
														"[data-placeholder]");
												var r = e(this.container).find(
														"[data-droptarget]");
												if (t.size() > 0
														&& r.size() > 0)
													r.remove();
